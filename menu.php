	...
	<div class="row">
		...
		<div class="container">
			...
			<div class="product-grid">
				<?php   $q="SELECT *, (SELECT name FROM menu WHERE id=product.menu_id) AS menu_name, (SELECT category_name FROM category WHERE id=product.category_id) AS category_name FROM product WHERE menu_id='$menu_id'"; $pr=$conn->query($q); ?>
